...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/quota-snapshots", s.mgmt.ListQuotaSnapshots)
		mgmt.POST("/quota-snapshots", s.mgmt.PutQuotaSnapshot)
		...
		mgmt.POST("/api-key-usage/clear-cooldown", s.mgmt.ClearAPIKeyUsageCooldown)
