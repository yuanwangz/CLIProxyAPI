...
func TestResolveCooldownStateStoreKeepsUpstreamStoreDisabled(t *testing.T) {
	...
	if got != nil {
		t.Fatalf("resolveCooldownStateStore() = %T, want nil while usagepersist owns cooldown persistence", got)
	}
}
